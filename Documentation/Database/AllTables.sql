...
--Hash Table
create table hashtag (hashid int generated by default as identity(start with 1 increment by 1) primary key,text varchar(50) not null,count int default 0 not null );