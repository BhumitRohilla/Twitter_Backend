--Users Table
create table users (u_id int primary key GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1), userName varchar(30) not null unique, password varchar(100) not null, twitterBlue boolean not null DEFAULT 'false', ProfilePicture varchar(100), headerPicture varchar(30), email varchar(40) not null unique);
--Bio Table
